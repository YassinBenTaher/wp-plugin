...
class AcceptStripePaymentsShortcode {
    ...
    function __construct() {
        ...
        add_shortcode('spare_payment', array(&$this, 'shortcode_accept_stripe_payment'));
        add_shortcode('spare_payment_checkout', array(&$this, 'shortcode_accept_stripe_payment_checkout'));
        if (!is_admin()) {
